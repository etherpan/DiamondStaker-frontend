      ...
      >
        <Flex flex="1" flexDirection="column">
          <Heading scale="xxl" color="primary" mb="24px">
            {t("Daughter Doge’s revenge By DDR finance")}
          </Heading>
          <Text mb="20px" fontSize="20px">
            {t('Earn reliable passive income by staking in our farms and pools')}
          </Text>
          <Text mb="20px" fontSize="20px">
            {t('Toal Value Locked')}
          </Text>
          ...
          <Flex>
            ...
            <Link mr="16px" href="https://pancakeswap.finance/swap?outputCurrency=0x20b9ffD06d32eAee94eDcd9098db01B2d13d4C61">
